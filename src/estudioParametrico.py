...
def estudioParametrico(output_dir:Path, estudio_web:bool,continuacion_estudio:bool, **kwargs):
    ...
    for paquete_argumentos in lista_con_todos_los_parametros:
        ...
        try:
            ...
            sol_final = draw_string_art_svg(**paquete_argumentos[2])
        except Exception as e:
...
if __name__ == "__main__":
    ...
    estudioParametrico(output_dir=Path("../ejemplos/local/prueba"), estudio_web= False, continuacion_estudio=True,
                       ruta_a_la_imagen="../ejemplos/ae300.jpg", numero_de_pines= 2,
