...
from .GA import obtener_camino_ag, obtener_camino_ag_con_semilla, obtener_camino_ag_cultivado
from .BasadasGrafos import obtener_camino_aco, obtener_camino_aco_semilla
